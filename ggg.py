...
mainn = types.InlineKeyboardButton(text='Главное меню', callback_data='menu_please')
...
def answer(call):
    ...
    #     client.send_message(call.from_user.id, text='Помните, что техники станут только помогающим инструментом при работе с тревогой. Они не заменяют полноценных консультаций.', reply_markup=tech_menu)
        ...
        client.send_photo(call.from_user.id, get("http://cubecode.ru/%D0%9A%D0%B0%D1%80%D1%82%D0%BE%D1%87%D0%BA%D0%B0%20%D0%B4%D0%BB%D1%8F%20%D0%BF%D0%B5%D1%80%D0%B5%D0%BA%D0%BB%D1%8E%D1%87%D0%B5%D0%BD%D0%B8%D1%8F%20%D0%B2%D0%BD%D0%B8%D0%BC%D0%B0%D0%BD%D0%B8%D1%8F.png").content)
    ...
    elif call.data =='menu_please':
        client.send_message(call.from_user.id, 'Выберите нужный раздел', reply_markup=bot_main_menu)
